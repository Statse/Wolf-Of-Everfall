...
class ResourceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $resources = [
            ...
            // axes
            [
                'name' => 'Iron Loggin Axe', 
                'tier' => 2,
                'slot_1' => json_encode(array('Fae Iron','Iron ingot')),
                'slot_1_amount' => 12,
                'slot_2' => json_encode(array('Timber')),
                'slot_2_amount' => 3,
                'slot_3' => json_encode(array('Coarse leather')),
                'slot_3_amount' => 2,
            ],
            [
                'name' => 'Steel Loggin Axe', 
                'tier' => 3,
                'slot_1' => "['Fae iron', 'Iron ore']",
                'slot_1_amount' => 12,
                'slot_2' => "['Timber']",
                'slot_2_amount' => 3,
                'slot_3' => "['Coarse leather']",
                'slot_3_amount' => 2,
            ],
            // [
            //     'name' => 'Starmetal Loggin Axe', 
            //     'tier' => 3,
            //     'slot_1' => "['Fae iron', 'Iron ore']",
            //     'slot_1_amount' => 12,
            //     'slot_2' => "['Timber']",
