            ...
            <div class="w-8/12 bg-white p-6 rounded-lg">
                ...
                <form action="{{route('register')}}") method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="" placeholder="Your name">
                    </div>
                    <div class="mb-4">
                        <label for="username" class="sr-only">Username</label>
                        <input type="text" id="username" name="username" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="" placeholder="Your username">
                    </div>
                    <div class="mb-4">
                        <label for="email" class="sr-only">Email</label>
                        <input type="text" id="email" name="email" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="" placeholder="Your email">
                    </div>
                    <div class="mb-4">
